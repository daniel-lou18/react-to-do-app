...
if (!allSavedProjects) {
  ...
  const task3 = new Task('Arroser les plantes', 'Ne pas oublier l\'aloë vera', exampleDate, 'inbox', 3);
  inbox.tasks.push(task3);
  const task4 = new Task('Prendre rdv chez le garagiste', 'Garage Vroum à Meudon, tél 06 55 55 55', exampleDate, 'inbox', 1);
  ...
  const task6 = new Task('Réparer la douche', 'Quincaillerie rue Damrémont', exampleDate, 'inbox', 3);
  ...
  const task1 = new Task('Réparer robinet', 'salle de bains', exampleDate, 'travaux', 2);
  travaux.tasks.push(task1);
  const task2 = new Task('Déboucher l\'évier', 'acheter du produit', exampleDate, 'travaux', 3);

...
const SaveTaskBtn = ({ projectSelection, taskNameText, description, prioritySelection, setShowAddTask }) => {
  ...
  const saveTaskHandler = e => {
    ...
    const newTask = new Task(taskNameText, description, 0, currProject.projectName, prioritySelection);
